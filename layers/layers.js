...
var format_NeriumoleanderL_18 = new ol.format.GeoJSON();
var features_NeriumoleanderL_18 = format_NeriumoleanderL_18.readFeatures(json_NeriumoleanderL_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NeriumoleanderL_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NeriumoleanderL_18.addFeatures(features_NeriumoleanderL_18);
var lyr_NeriumoleanderL_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NeriumoleanderL_18, 
                style: style_NeriumoleanderL_18,
                popuplayertitle: 'Nerium oleander L',
                interactive: true,
                title: '<img src="styles/legend/NeriumoleanderL_18.png" /> Nerium oleander L'
            });
var format_FoodCourt_19 = new ol.format.GeoJSON();
var features_FoodCourt_19 = format_FoodCourt_19.readFeatures(json_FoodCourt_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FoodCourt_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FoodCourt_19.addFeatures(features_FoodCourt_19);
var lyr_FoodCourt_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FoodCourt_19, 
                style: style_FoodCourt_19,
                popuplayertitle: 'Food Court',
                interactive: true,
                title: '<img src="styles/legend/FoodCourt_19.png" /> Food Court'
            });
var format_CrcketGround_20 = new ol.format.GeoJSON();
var features_CrcketGround_20 = format_CrcketGround_20.readFeatures(json_CrcketGround_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CrcketGround_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CrcketGround_20.addFeatures(features_CrcketGround_20);
var lyr_CrcketGround_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CrcketGround_20, 
                style: style_CrcketGround_20,
                popuplayertitle: 'Crcket Ground',
                interactive: true,
                title: '<img src="styles/legend/CrcketGround_20.png" /> Crcket Ground'
            });
var format_FootBallGround_21 = new ol.format.GeoJSON();
var features_FootBallGround_21 = format_FootBallGround_21.readFeatures(json_FootBallGround_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FootBallGround_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FootBallGround_21.addFeatures(features_FootBallGround_21);
var lyr_FootBallGround_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FootBallGround_21, 
                style: style_FootBallGround_21,
                popuplayertitle: 'Foot Ball Ground',
                interactive: true,
                title: '<img src="styles/legend/FootBallGround_21.png" /> Foot Ball Ground'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_Roads_1.setVisible(true);lyr_AdminBlock_2.setVisible(true);lyr_Tower1_3.setVisible(true);lyr_Tower2_4.setVisible(true);lyr_Tower3_5.setVisible(true);lyr_Tower4_6.setVisible(true);lyr_Tower5_7.setVisible(true);lyr_AnapurnaMess_8.setVisible(true);lyr_HotwaterGenerator_9.setVisible(true);lyr_BasketBallCourt_10.setVisible(true);lyr_VedavatiHostel_11.setVisible(true);lyr_GangaHostel_12.setVisible(true);lyr_SRBlock_13.setVisible(true);lyr_CVRamanBlock_14.setVisible(true);lyr_XLab_15.setVisible(true);lyr_JCBose_16.setVisible(true);lyr_TennisCourt_17.setVisible(true);lyr_NeriumoleanderL_18.setVisible(true);lyr_FoodCourt_19.setVisible(true);lyr_CrcketGround_20.setVisible(true);lyr_FootBallGround_21.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_Roads_1,lyr_AdminBlock_2,lyr_Tower1_3,lyr_Tower2_4,lyr_Tower3_5,lyr_Tower4_6,lyr_Tower5_7,lyr_AnapurnaMess_8,lyr_HotwaterGenerator_9,lyr_BasketBallCourt_10,lyr_VedavatiHostel_11,lyr_GangaHostel_12,lyr_SRBlock_13,lyr_CVRamanBlock_14,lyr_XLab_15,lyr_JCBose_16,lyr_TennisCourt_17,lyr_NeriumoleanderL_18,lyr_FoodCourt_19,lyr_CrcketGround_20,lyr_FootBallGround_21];
...
lyr_NeriumoleanderL_18.set('fieldAliases', {'id': 'id', });
lyr_FoodCourt_19.set('fieldAliases', {'id': 'id', });
lyr_CrcketGround_20.set('fieldAliases', {'id': 'id', });
lyr_FootBallGround_21.set('fieldAliases', {'id': 'id', });
...
lyr_NeriumoleanderL_18.set('fieldImages', {'id': 'TextEdit', });
lyr_FoodCourt_19.set('fieldImages', {'id': '', });
lyr_CrcketGround_20.set('fieldImages', {'id': '', });
lyr_FootBallGround_21.set('fieldImages', {'id': '', });
...
lyr_NeriumoleanderL_18.set('fieldLabels', {'id': 'no label', });
lyr_FoodCourt_19.set('fieldLabels', {'id': 'no label', });
lyr_CrcketGround_20.set('fieldLabels', {'id': 'inline label - visible with data', });
lyr_FootBallGround_21.set('fieldLabels', {'id': 'no label', });
lyr_FootBallGround_21.on('precompose', function(evt) {
